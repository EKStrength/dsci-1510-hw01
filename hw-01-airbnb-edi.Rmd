...
```
```{r}
"The faceting layout I choose gives room for each neighborhood to be studied seperately."
```
...
#Looking over the ridge plots and the summary statistics, it is apparent that Old Town has the largest number of expensive Airbnbs comparatively. The cheapest neighborhood on average is definitely Bruntsfield, with a minimum price of $10 and a median price of $80. All of the neighborhoods contain very expensive Airbnbs with most of them containing houses that cost $900 or more per night, except Stockbridge at a maximum of $750. Interestingly, Stockbridge has both the highest minimum per night(21) and the lowest max per night(750).
...
#From the data visualization I created, it appears that most people give their Airbnb a good rating, at least an 80/100 or higher. Although not everyone does, with many people giving a rating of 70/100 or 60/100 and some people even rating their Airbnb a 20/100. Some of the best neighborhoods according to reviews, appear to be Morningside, Marchmont, and Stockbridge since they mostly have reviews above 60/100. The worst-reviewed neighborhoods appear to be Old Town, Leith, and Newington because they all have many reviews below the 60/100 mark. The Airbnbs not classified to a particular neighborhood (NA) have a pretty extreme range of reviews with many being below 60/100, but many also being 80/100 or higher. 
```
